...
function(cmaki_find_package PACKAGE)
	...
	if(NOT EXISTS "${package_marker}" OR "${NO_USE_CACHE_LOCAL}")
		...
		set(http_package_filename "${CMAKI_REPOSITORY}/download.php?file=${package_cmake_filename}")
		set(package_compessed "${depends_dir}/${package_filename}")
		...
		if(NOT "${NO_USE_CACHE_REMOTE}")
			...
			set(COPY_SUCCESFUL2 "${COPY_SUCCESFUL}")
		endif()
		# Si no puede descargar el artefacto ya hecho (es que necesito compilarlo y subirlo)
		if(NOT "${COPY_SUCCESFUL1}" OR NOT "${COPY_SUCCESFUL2}" OR "${NO_USE_CACHE_REMOTE}")
