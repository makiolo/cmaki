...
function(cmaki_install_file FROM)
    foreach(BUILD_TYPE ${CMAKE_BUILD_TYPE})
		INSTALL(FILES ${FROM} DESTINATION ${CMAKE_INSTALL_PREFIX}/${BUILD_TYPE} CONFIGURATIONS ${BUILD_TYPE} USE_SOURCE_PERMISSIONS)
    endforeach()
endfunction()

function(cmaki_install_file_into FROM TO)
    foreach(BUILD_TYPE ${CMAKE_BUILD_TYPE})
		INSTALL(FILES ${FROM} DESTINATION ${CMAKE_INSTALL_PREFIX}/${BUILD_TYPE}/${TO} CONFIGURATIONS ${BUILD_TYPE} USE_SOURCE_PERMISSIONS)
    endforeach()
endfunction()

function(cmaki_install_file_and_rename FROM NEWNAME)
    foreach(BUILD_TYPE ${CMAKE_BUILD_TYPE})
		INSTALL(FILES ${FROM} DESTINATION ${CMAKE_INSTALL_PREFIX}/${BUILD_TYPE} CONFIGURATIONS ${BUILD_TYPE} RENAME ${NEWNAME} USE_SOURCE_PERMISSIONS)
    endforeach()
endfunction()

function(cmaki_install_file_into_and_rename FROM TO NEWNAME)
    foreach(BUILD_TYPE ${CMAKE_BUILD_TYPE})
		INSTALL(FILES ${FROM} DESTINATION ${CMAKE_INSTALL_PREFIX}/${BUILD_TYPE}/${TO} CONFIGURATIONS ${BUILD_TYPE} RENAME ${NEWNAME} USE_SOURCE_PERMISSIONS)
    endforeach()
endfunction()
...
function(cmaki_install_files FROM)
    foreach(BUILD_TYPE ${CMAKE_BUILD_TYPE})
		...
		INSTALL(FILES ${files} DESTINATION ${CMAKE_INSTALL_PREFIX}/${BUILD_TYPE} CONFIGURATIONS ${BUILD_TYPE} USE_SOURCE_PERMISSIONS)
    endforeach()
endfunction()
...
function(cmaki_install_files_into FROM TO)
    foreach(BUILD_TYPE ${CMAKE_BUILD_TYPE})
        FILE(GLOB files ${FROM})
		INSTALL(FILES ${files} DESTINATION ${CMAKE_INSTALL_PREFIX}/${BUILD_TYPE}/${TO} CONFIGURATIONS ${BUILD_TYPE} USE_SOURCE_PERMISSIONS)
    endforeach()
endfunction()
...
macro(cmaki_install_inside_dir _DESTINE)
    ...
    foreach(ITEM ${DEPLOY_FILES_AND_DIRS})
       ...
       ENDIF()
    endforeach()
	INSTALL(FILES ${FILES_TO_DEPLOY} DESTINATION ${CMAKE_INSTALL_PREFIX}/${CMAKE_BUILD_TYPE} USE_SOURCE_PERMISSIONS)
...
function(cmaki_executable)
	...
	foreach(BUILD_TYPE ${CMAKE_BUILD_TYPE})
		INSTALL(    TARGETS ${_EXECUTABLE_NAME}
					...
					CONFIGURATIONS ${BUILD_TYPE} USE_SOURCE_PERMISSIONS)
	endforeach()
	generate_clang()
